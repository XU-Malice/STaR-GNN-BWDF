...
**Note.** STGCN is an independent graph baseline and is excluded from the factorial ablation. At 168 h, SAS-Norm-only has the marginally lower total MAE (12.208 vs. 12.234), whereas the full STaR-GNN is best in MAPE, RMSE and NSE. The corresponding paired moving-block analysis is reported with Main Fig. 4.
