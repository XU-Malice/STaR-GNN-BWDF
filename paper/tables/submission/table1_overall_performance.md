...
|---|---|---:|---:|---:|---:|
| **24 h** | **Published reference models** |  |  |  |  |
...
**Note.** † Results reported by Que et al. (2024). DCRNN, STGCN and STaR-GNN were evaluated under the common 46-origin protocol. All manuscript values use uniform three-decimal display precision; the source CSV retains full precision.
